<template>
    <div class="main-container">
        <div class="container my-5">
            ...
            <div ref="productCarousel" id="productCarousel" class="carousel slide" data-bs-ride="carousel">
        ...
        onMounted(() => {
            if (productCarousel.value) {
                carouselInstance = new Carousel(productCarousel.value, {
                    interval: 3000, // Mantener desplazamiento automático
                });
            }
            calcularGrupos(); // Inicializa los grupos
